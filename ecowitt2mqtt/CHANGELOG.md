...
- https://github.com/jumpinf00l/ecowitt2mqtt/releases/tag/2026.4.0

## Changes

- Consolidated into a single Github repository
- Aligned versioning of ecowitt2mqtt Python app with container/releases
- Added 'illuminance' entity
...
- Added 'illuminance_perceived' entity
- Configured app to shut down for backups (cold backups)
...
- The 'irradiance' entity (replaces the 'solarradiation' entity) now uses the 'irradiance' device class
  - Will always report in "W/m²"
- Intended for use only as a Home Assistant App, not tested as a traditional Docker container
