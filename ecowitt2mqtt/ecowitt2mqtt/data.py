...
from ecowitt2mqtt.helpers.calculator.illuminance import (
    ...
    IlluminancePerceptionCalculator,
...
CALCULATOR_MAP: dict[str, type[Calculator]] = {
    ...
    DATA_POINT_ILLUMINANCE: IlluminanceCalculator,
    DATA_POINT_ILLUMINANCE_PERCEPTION: IlluminancePerceptionCalculator,
    DATA_POINT_ILLUMINANCE_PERCEIVED: IlluminancePerceivedCalculator,
    ...
    DATA_POINT_SOLARRADIATION: SolarRadiationCalculator,
